/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 77026e2e55bdcb4d045121c58d655a8f)
// Runtime types generated with workerd@1.20260205.0 2026-02-05 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./dist/_worker.js/index");
		durableNamespaces: "PersonalReadmeAgent";
	}
	interface Env {
		AI: Ai;
		ASSETS: Fetcher;
		WORKERS_AI_MODEL: string;
		PersonalReadmeAgent: DurableObjectNamespace<import("./dist/_worker.js/index").PersonalReadmeAgent>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WORKERS_AI_MODEL">> {}
}
